...
func compileProtobufs(ctx context.Context, library *config.Library, module *config.SwiftModule, src *sources.Sources) error {
	...
	return addBoilerplateToGrpc(module, library)
}

// addBoilerplateToGrpc finds all the gRPC-generated files for `module` and adds
...
func addBoilerplateToGrpc(module *config.SwiftModule, library *config.Library) error {
	...
	return filepath.WalkDir(module.Output, func(path string, d os.DirEntry, err error) error {
		...
		newContents := append(want, contents...)
		return os.WriteFile(path, newContents, 0644)
	})
}

func gRPCFileBoilerplate(year string) []byte {
