...
// Package rust provides Rust specific functionality for creating, generating,
// and releasing client libraries.
package rust
...
// formatAndValidateLibrary runs formatter, tests, and validation tasks on the
