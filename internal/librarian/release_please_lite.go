...
func GetConventionalCommitsSinceLastRelease(repo *gitrepo.LocalRepository, library *config.LibraryState) ([]*gitrepo.ConventionalCommit, error) {
	var paths []string
	...
	conventionalCommits := []*gitrepo.ConventionalCommit{}
