...
var APIs = []API{
	...
	{Path: "google/cloud/apigeeregistry/v1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPCRest, LangRuby: GRPCRest}},
	...
	{Path: "google/cloud/asset/v1p5beta1", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPCRest}},
	...
	{Path: "google/cloud/bigquery/biglake/v1", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPCRest}},
	{Path: "google/cloud/bigquery/biglake/v1alpha1", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPCRest}},
	{Path: "google/cloud/bigquery/connection/v1"},
	{Path: "google/cloud/bigquery/dataexchange/v1beta1", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC}},
	{Path: "google/cloud/bigquery/datapolicies/v1"},
	{Path: "google/cloud/bigquery/datapolicies/v1beta1", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC}},
	...
	{Path: "google/cloud/bigquery/migration/v2alpha", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC}},
	{Path: "google/cloud/bigquery/reservation/v1"},
	{Path: "google/cloud/bigquery/storage/v1", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPC, LangJava: GRPC, LangNodejs: GRPC, LangPhp: GRPCRest, LangPython: GRPC}},
	{Path: "google/cloud/bigquery/storage/v1alpha", Languages: []string{LangPython}, Transports: map[string]Transport{LangAll: GRPC}},
	{Path: "google/cloud/bigquery/storage/v1beta", Languages: []string{LangPython}, Transports: map[string]Transport{LangAll: GRPC}},
	{Path: "google/cloud/bigquery/storage/v1beta2", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPCRest, LangJava: GRPC, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC}},
	...
	{Path: "google/cloud/billing/budgets/v1beta1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPC, LangGo: GRPCRest, LangJava: GRPC, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC, LangRuby: GRPC}},
	...
	{Path: "google/cloud/channel/v1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPCRest, LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC, LangRuby: GRPCRest}},
	...
	{Path: "google/cloud/datacatalog/v1beta1", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC, LangRuby: GRPCRest}},
	...
	{Path: "google/cloud/datalabeling/v1beta1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPC, LangGo: GRPCRest, LangJava: GRPC, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC, LangRuby: GRPC}},
	{Path: "google/cloud/dataplex/v1"},
	{Path: "google/cloud/dataproc/v1"},
	{Path: "google/cloud/dataqna/v1alpha", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPCRest}},
	...
	{Path: "google/cloud/gkeconnect/gateway/v1beta1", Languages: []string{LangPython}, Transports: map[string]Transport{LangAll: Rest}},
	...
	{Path: "google/cloud/mediatranslation/v1beta1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPC, LangGo: GRPC, LangJava: GRPC, LangNodejs: GRPC, LangPhp: GRPCRest, LangPython: GRPC, LangRuby: GRPC}},
	...
	{Path: "google/cloud/memorystore/v1beta", Languages: []string{LangPython}, Transports: map[string]Transport{LangAll: Rest}},
	...
	{Path: "google/cloud/networkconnectivity/v1alpha1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPC, LangGo: GRPCRest, LangJava: GRPC, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC, LangRuby: GRPC}},
	...
	{Path: "google/cloud/notebooks/v1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPCRest, LangGo: GRPC, LangJava: GRPC, LangNodejs: GRPC, LangPhp: GRPCRest, LangPython: GRPC, LangRuby: GRPCRest}},
	{Path: "google/cloud/notebooks/v1beta1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPC, LangGo: GRPCRest, LangJava: GRPC, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPCRest, LangRuby: GRPC}},
	...
	{Path: "google/cloud/tpu/v1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPC, LangGo: GRPC, LangJava: GRPC, LangNodejs: GRPC, LangPhp: GRPCRest, LangPython: GRPC, LangRuby: GRPC}},
	...
	{Path: "google/cloud/videointelligence/v1p3beta1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPCRest, LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC, LangRuby: GRPCRest}},
	...
	{Path: "google/cloud/workflows/executions/v1beta", Languages: []string{LangPython}, Transports: map[string]Transport{LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPC}},
	...
	{Path: "google/maps/addressvalidation/v1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPC, LangGo: GRPCRest, LangJava: GRPCRest, LangNodejs: GRPCRest, LangPhp: GRPCRest, LangPython: GRPCRest, LangRuby: GRPC}},
	...
	{Path: "google/maps/fleetengine/v1", Languages: []string{LangPython}, Transports: map[string]Transport{LangCsharp: GRPCRest, LangGo: GRPC, LangJava: GRPC, LangNodejs: GRPC, LangPhp: GRPCRest, LangPython: GRPC, LangRuby: GRPCRest}},
	...
	{Path: "google/shopping/type", Languages: []string{LangPython}, Transports: map[string]Transport{LangPython: GRPCRest}},
