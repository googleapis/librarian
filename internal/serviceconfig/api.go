...
var APIs = []API{
	...
	{Path: "google/ai/generativelanguage/v1beta", Languages: []string{LangGo, LangPython, LangDart}},
	...
	{Path: "google/cloud/aiplatform/v1beta1", ServiceConfig: serviceConfigAIPlatformV1Beta1, Languages: []string{LangGo, LangPython, LangDart}},
