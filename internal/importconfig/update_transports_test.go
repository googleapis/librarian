...
var APIs = []API{
	{Path: "google/cloud/foo/v1", Transports: map[string]string{langAll: "rest"}},
}
`,
			buildBazel: `
php_gapic_library(
...
var APIs = []API{
	{Path: "google/cloud/foo/v1", Transports: map[string]string{langPhp: "grpc+rest"}},
}
`,
		},
		{
...
var APIs = []API{
	{Path: "google/cloud/foo/v1", Transports: map[string]string{langGo: "grpc"}},
}
`,
		},
		{
