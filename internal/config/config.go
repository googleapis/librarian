...
type Config struct {
	...
	// automatically.
	//
	// APISource is used by the generate and configure commands.
	//
	...
	// GitHub.
	//
	// GitHubToken is used by configure, generate, release init, and update-image
	// commands when Push is true, as well as release tag-and-release whenever
	// it is run.
	//
	...
	// configure, generate, release init, release tag-and-release, update-image.
	//
