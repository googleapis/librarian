...
6) Run [librarian generate command](https://pkg.go.dev/github.com/googleapis/librarian/cmd/librarian#hdr-generate).  The output should be 0 diff, check with your language lead/generator owner if this is not the case.
