...
4) There is no requirement to stop using library-specific post-processing files as part of this migration. However, any post processing should be included in a file called librarian(suffix).
