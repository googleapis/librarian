...
| `idempotency_hook` | string | Configures an opt-in method on the request struct (e.g. "resolve_idempotency") to resolve idempotency and transform RequestOptions before dispatch. |
