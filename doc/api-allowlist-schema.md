...
| `ReleaseLevels` | map[string]string | ReleaseLevel is the release level, such as "stable" or "preview". The value is different among languages. The key is the language name, e.g., "go", "python". Optional. If omitted, the value is empty. |
