...
Once a Library is onboarded to Librarian automation, it is expected that the 
Librarian team will approve and merge PRs generated by Librarian and
maintainers should not be involved in the process.
