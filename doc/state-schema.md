...
| `release_exclude_paths` | list   | A list of directories to exclude from the release. Files matching these paths will not be considered part of a commit for this library.                                                                                                                    | No       | Each entry must be a valid directory path.     |
